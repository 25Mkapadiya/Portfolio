export const SPIRAL = {
  ...
  // Continuous bookcase dimensions. Keep the spiral path untouched while
  // giving the furniture enough mass to read as a built object rather than a
  // thin procedural ribbon.
  innerRadius: 2.48,
  shelfDepth: 1.44,
  shelfThickness: 0.19,
  backThickness: 0.15,
